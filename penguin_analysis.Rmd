...
# Increased transparency, and apply jitter to improve clarity
...
# Format the table to keep consistent design across all figures.
...
# Create a data frame with the relevant results from the summary table, rounded for readability
ancova_table_df <- data.frame(
  ...
  `p-value` = format.pval(ancova_summary[[1]]$`Pr(>F)`, digits = 3))
...
# Generates a data frame with altered column titles and rounded numbers to 3 decimal places to enhance readability
    bind_rows() 
...
# Q-Q Plot, testing for normality in residuals.
...
# Histogram of residuals, testing for normality in residuals.
ANCOVA_hist_plot <- ggplot(ANCOVAmodel_data, aes(x = residuals)) + 
  geom_histogram(binwidth = 1, fill = "lightblue", color = "black", alpha = 0.7) + 
  ggtitle("Histogram of Residuals") + 
  theme_minimal()

# Residuals vs Fitted plot, testing for linearity and heteroscedasticity.
...
# Scale-Location plot, testing for heteroscedasticity in residuals
